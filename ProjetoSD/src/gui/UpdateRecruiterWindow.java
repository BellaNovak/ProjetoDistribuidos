...
public class UpdateRecruiterWindow extends JDialog {
	...
	public static void main(String[] args) {
		try {
			...
			UpdateRecruiterWindow dialog = new UpdateRecruiterWindow();
	...
	public UpdateRecruiterWindow() {
		
		setTitle("Update da empresa");
